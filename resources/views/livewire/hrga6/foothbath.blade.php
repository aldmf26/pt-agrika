        ...
        <div class="row">
            ...
            <div class="col-lg-3">
                <div class="mb-3">
                    ...
                    <div wire:ignore>
                        <select required wire:model.live="selectedArea" x-data="{ selectedOption: @entangle('selectedArea') }"
                            class="form-select selectArea">
            ...
            <table class="table table-bordered ">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        @for ($i = 1; $i <= $daysInMonth; $i++)
                            <td class="pointer">
                                <x-dropdown-paraf tbl="foothbath_ceklis" :items="$adminSanitasi['petugas']" type="paraf_petugas"
                    ...
                    <tr>
                        ...
                        @for ($i = 1; $i <= $daysInMonth; $i++)
                            <td>
                                <x-dropdown-paraf tbl="foothbath_ceklis" :items="$adminSanitasi['verifikator']" type="verifikator"
                                    :date="$tahun . '-' . $selectedBulan . '-' . $i" :selectedArea="$selectedArea" :selectedBulan="$selectedBulan" :day="$i" />
                            </td>
                        @endfor
                    </tr>
