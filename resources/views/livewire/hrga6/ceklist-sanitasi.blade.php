                ...
                <table class="table table-bordered ">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            @for ($i = 1; $i <= $daysInMonth; $i++)
                                <td class="pointer">
                                    <x-dropdown-paraf tbl="sanitasi" :items="$adminSanitasi['petugas']" type="paraf_petugas"
                        ...
                        <tr>
                            ...
                            @for ($i = 1; $i <= $daysInMonth; $i++)
                                <td>
                                    <x-dropdown-paraf tbl="sanitasi" :items="$adminSanitasi['verifikator']" type="verifikator"
                                        :date="$tahun . '-' . $selectedBulan . '-' . $i" :selectedArea="$selectedArea" :selectedBulan="$selectedBulan" :day="$i" />
                                </td>
                            @endfor
                        </tr>
