    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-6 mt-4">
                <div class="shapes">
                    <p class="cop_judul">FORM SERAH TERIMA PEMBERSIHAN BAHAN BAKU KE PENCABUTAN</p>
                    <p class="text-center fst-italic">handover form raw material preparing and cleaning to feather
                        removal</p>
                </div>
            </div>
            <div class="col-3 ">
                <p class="cop_text">Dok.No.: FRM.PRO.01.02, Rev.00</p>
                <br>
                <br>
            </div>
            <div class="col-lg-12">
