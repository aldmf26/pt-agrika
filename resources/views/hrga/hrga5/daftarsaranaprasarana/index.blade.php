<x-app-layout title="{{ $title }}">
                            ...
                            <tr>
                                ...
                                <td class="text-nowrap">
                                    ...
                                    <a onclick="return confirm('Yakin ingin menghapus data ini?')"
                                        href="{{ route('daftar.1.delete', ['id' => $i->id]) }}"
    ...
    <!-- FORM -->
    <form action="{{ route('daftar.1.store') }}" method="post">
        @csrf
            ...
            <div class="modal-dialog modal-xlplus">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row mb-2">
                            <div class="col-lg-3">
                                <input type="text" class="form-control" name="nama_item"
                                    placeholder="Nama Sarana dan Prasarana" required>
                            </div>
                            <div class="col-lg-2">
                            ...
                            <div class="col-lg-2">
                                <select name="jenis_item" class="select2 jenis" id="">
                            ...
                            <div class="col-lg-4 mt-2 ruangan" style="display: none;">
                        ...
                        <div x-data="itemForm()" class="row ruangan" style="display: none;">
    ...
    <form action="{{ route('daftar.1.update') }}" method="post">
        @csrf
