        ...
        <div class="col-11">
            <table>
                ...
                <tr>
                    ...
                    <td>:</td>
                    <td></td>
                    <td>Adanya penambahan kapasitas aktivitas {{$datas->jabatan}}</td>
                </tr>
            </table>
        </div>
    </div>
        ...
        <div class="col-11">
            ...
            <table>
                ...
                <tr>
                    <td >3. Pendidikan</td>
                    <td>:</td>
                    <td>Open seluruh pengalaman pendidikan</td>
                </tr>
                <tr>
                    <td>4. Pengalaman</td>
                    <td>:</td>
                    <td>Open / Non Pengalaman</td>
                </tr>
                <tr>
                    <td>5. Pelatihan</td>
                    <td>:</td>
                ...
                <tr>
                    ...
                    <td>:</td>
                    <td>Aktivitas cabut bulu per tray / nampan dengan kapasitas 5-10 gram</td>
                </tr>
                <tr>
                    <td colspan="3">&nbsp;</td>
                </tr>
                <tr>
                    ...
                    <td>:</td>
                    <td>{{tanggal($datas->tgl_dibutuhkan)}} <span style="margin-left: 20%">Diajukan Oleh: Widani</span></td>
                </tr>
                <tr>
                    <td colspan="3">&nbsp;</td>
                </tr>
