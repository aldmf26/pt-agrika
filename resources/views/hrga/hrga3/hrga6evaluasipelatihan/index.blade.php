                ...
                <tbody>
                    @foreach ($evaluasi as $e)
                        <tr>
                            ...
                            <td>{{ ucfirst(strtolower($e->tema_pelatihan)) }}</td>
                            <td>{{ ucfirst(strtolower($e->data_pegawai->nama)) }}</td>
                            ...
                            <td>{{ ucfirst(strtolower($e->data_pegawai->status)) }}</td>
                            <td>{{ date('d-m-Y', strtotime($e->data_pegawai->tgl_masuk)) }}</td>
                            <td>{{ ucfirst(strtolower($e->data_pegawai->posisi)) }}</td>
                            <td>
