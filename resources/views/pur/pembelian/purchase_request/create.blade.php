    ...
    <div class="row"> 
        ...
        <div class="col-3">
            <div class="form-group">
                ...
                <input type="text" name="manajer_departemen" placeholder="manajer departemen" class="form-control">
            </div>
        </div>
        <div class="col-6">
            <div class="form-group">
            ...
            <table class="table table-bordered">
                ...
                <tbody>
                    <template x-for="(row, index) in rows">
                        <tr>
                            <td>
                                <input required autocomplete="off" type="text" inputmode="numeric" name="jumlah[]" class="form-control form-control-sm" />
                            </td>
                            <td>
                                <input autocomplete="off" type="text" name="item_spesifikasi[]" class="form-control form-control-sm" />
                            </td>
                            <td>
                                <input type="date" name="tgl_dibutuhkan[]" class="form-control form-control-sm" />
                            </td>
                            <td>
                    ...
                    <tr>
                        <td colspan="4">
                            <button class="btn btn-xs btn-info text-white btn-block" @click="rows.push('')"><i class="fas fa-plus"></i> Baris</button>
                        </td>
                    </tr>
                </tbody>
            </table>
