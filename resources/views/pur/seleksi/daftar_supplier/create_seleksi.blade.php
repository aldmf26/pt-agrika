                                                        ...
                                                        <div>
                                                            ...
                                                            <div class="form-check form-check-inline">
                                                                <input class="form-check-input" type="radio" name="reg_rwb"
                                                                    ...
                                                                    {{ isset($seleksi) && $seleksi->reg_rwb == 'Tidak relevan' ? 'checked' : 'checked' }}>
...
@endif
                                        ...
                                        @case('pembayaran')
                                            <div class="form-group mb-3">
                                                ...
                                                <input name="jatuh_tempo" type="text" class="form-control"
                                                    value="{{ $seleksi->jatuh_tempo ?? 'langsung' }}">
                                            </div>
                                        @break
                                        ...
                                        @case('lab')
                                            <div class="form-group mb-3">
                                                ...
                                                <textarea name="hasil_pemeriksaan_lab" class="form-control" rows="3">{!! $seleksi->hasil_pemeriksaan_lab ?? '' !!}</textarea>
                                            </div>
                                            ...
                                            <div class="form-group mb-3">
                                                ...
                                                <div>
                                                    ...
                                                    <div class="form-check form-check-inline">
                                                        ...
                                                        <label class="form-check-label" for="lab-tidak-lulus">Tidak
                                                            Lulus
                                                            Pengujian</label>
                                                    </div>
                                                </div>
                                        ...
                                        @case('penerimaan')
                                            <div class="form-group mb-3">
                                                <label class="form-label">Hasil Pemeriksaan</label>
                                                <textarea name="hasil_pemeriksaan_penerimaan" class="form-control" rows="3">{!! $seleksi->hasil_pemeriksaan_penerimaan ?? '' !!}</textarea>
                                            </div>
                                        ...
                                        @default
                                            ...
                                            <div class="form-group mb-3">
                                                <label class="form-label">Hasil Pemeriksaan</label>
                                                <textarea name="hasil_pemeriksaan_hewan" class="form-control" rows="3">{!! $seleksi->hasil_pemeriksaan_hewan ?? '' !!}</textarea>
                                            </div>
