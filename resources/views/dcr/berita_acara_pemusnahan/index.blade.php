<x-app-layout title="{{ $title }}">
                ...
                <table class="table table-bordered" id="example">
                    <thead>
                        <tr>
                            ...
                            <th class="text-center">Cakupan Pemusnahan</th>
                            <th class="text-center">Divisi</th>
                            <th class="text-center">Inisial</th>
                            <th class="text-center">Alasan Pemusnahan</th>
                            <th class="text-center">Tgl Pemusnahan</th>
                    ...
                    <tbody>
                        @foreach ($dokumen as $d)
                            <tr>
                                ...
                                <td>{{ tanggal($d->tgl_pemusnahan) }}</td>
                                <td></td>
                            </tr>
                        @endforeach
    ...
    <form action="{{ route('dcr.7.store') }}" method="post" enctype="multipart/form-data">
        @csrf
                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="col-lg-4 ">
                                ...
                                <input type="text" class="form-control " name="cakupan_pemusnahan" id=""
                                    required>
                            </div>
                            <div class="col-lg-2 ">
                            ...
                            <div class="col-lg-2 mt-2">
                                ...
                                <input type="text" class="form-control " name="inisial" id="" required>
                            </div>


                            <div class="col-lg-4 mt-2">
                                <label for="">Alasan Pemusnahan</label>
                                <input type="text" class="form-control " name="alasan_pemusnahan" id=""
                                    required>
                            </div>
                            <div class="col-lg-2 mt-2">
                                <label for="">Tgl Pemusnahan</label>
                                <input type="date" class="form-control " name="tgl_pemusnahan" id=""
                                    required>
                            </div>
                            {{-- perubahan --}}
