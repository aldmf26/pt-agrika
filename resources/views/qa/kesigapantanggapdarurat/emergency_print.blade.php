            ...
            <table class="table-judul mb-3">
                ...
                <tr>
                    <td colspan="1" rowspan="2">
                        <div class="text-center fw-bold">Emergency Situation</div>
                    </td>
                    <td>
                        Tanggal Efektif
                    </td>
                    ...
                    <table class="table table-bordered table-sm" style="font-size: 11px">
                        <thead>
                            <tr>
                                ...
                                <th class="text-center align-middle">Ruang <br> Lingkup</th>
                                <th class="text-center align-middle">Reason <br> (Contribution to Quality & Food Safety
                                    Issue)</th>
                            </tr>
                        </thead>
                        <tbody>
