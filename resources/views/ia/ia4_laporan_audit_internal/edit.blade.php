            ...
            <div class="row g-3">
                ...
                <div class="col-md-4 col-sm-4">
                    <div>
                        ...
                        <select name="divisi" class="selectAudtor" id="">
                            ...
                            @foreach ($divisi as $d)
                                <option @selected($laporan->divisi == $d->divisi) value="{{ $d->divisi }}">{{ $d->divisi }}
                                </option>
                            @endforeach
                        </select>
                    </div>
                ...
                <div class="col-md-4 col-sm-12">
                    <div>
                        ...
                        <textarea rows="10" class="form-control" id="tindakan" name="finding" required>{{ $laporan->finding }}</textarea>
